...
import fi.spectrum.core.domain.{address, Address, HexString, TokenId}
...
object LiquidityLockInfo {
  ...
  implicit def schemaLiquidityLockInfo: Schema[LiquidityLockInfo] = Schema
    ...
    .modify(_.percent)(_.description("Percent ration of locked amount to total liquidity in the pool"))
    .encodedExample(
      LiquidityLockInfo(
