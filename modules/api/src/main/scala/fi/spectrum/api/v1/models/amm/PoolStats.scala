...
object PoolStats {
  ...
  implicit val schema: Schema[PoolStats] =
    Schema
      .derived[PoolStats]
      ...
      .modify(_.tvl)(_.description("Total value locked for given pool"))
      .modify(_.volume)(_.description("Volume for given pool within time window"))
      .modify(_.fees)(_.description("Fees for given pool"))
      .modify(_.yearlyFeesPercent)(_.description("Year fee percent for given pool"))
      .encodedExample(
        PoolStats(
          PoolId(
