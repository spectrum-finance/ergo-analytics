...
final case class PoolStatsDifferentAPR(
  id: PoolId,
  lockedX: FullAsset,
  lockedY: FullAsset,
  ...
  yearlyFeesPercent30D: FeePercentProjection
)

object PoolStatsDifferentAPR {

  implicit def poolStatsSchema: Schema[PoolStatsDifferentAPR] =
    Schema
      .derived[PoolStatsDifferentAPR]
      ...
      .modify(_.yearlyFeesPercent)(_.description("APR 24h"))
      .modify(_.yearlyFeesPercent30D)(_.description("APR 30d"))
      .encodedExample(
        PoolStatsDifferentAPR(
          PoolId(
