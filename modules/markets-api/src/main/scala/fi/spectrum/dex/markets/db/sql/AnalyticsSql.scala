...
import fi.spectrum.dex.markets.db.models.amm.{AssetInfo, AvgAssetAmounts, DepositInfo, PoolFeesSnapshot, PoolInfo, PoolSnapshot, PoolTrace, PoolVolumeSnapshot, SwapInfo}
