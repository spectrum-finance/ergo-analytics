package fi.spectrum.dex.markets.modules

import cats.{FlatMap, Functor, Monad}
import cats.data.OptionT
import fi.spectrum.core.common.{AssetClass, AssetEquiv, CryptoUnits, Currency, FiatUnits, FullAsset, ValueUnits}
import fi.spectrum.core.domain.constants
import fi.spectrum.core.domain.constants.ErgoAssetDecimals
import fi.spectrum.dex.markets.db.models.amm.PoolSnapshot
import fi.spectrum.dex.markets.services.{FiatRates, Markets}
import fi.spectrum.dex.markets.db.models.amm.PoolSnapshot
import fi.spectrum.dex.markets.services.{FiatRates, Markets}
